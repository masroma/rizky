    ...
    <x-slot name="header">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit User</h3>
                <p class="text-subtitle text-muted">Edit data pengguna aplikasi</p>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('user.update', ['user' => $user->id]) }}" method="post">
                    ...
                    <!-- Tambahkan input untuk mengedit password jika diperlukan -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                            ...
                            <option value="mengundurkan_diri" {{ old('status', $user->status) === 'mengundurkan_diri' ? 'selected' : '' }}>Mengundurkan Diri</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
